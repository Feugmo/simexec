...
] = "/home/tetsassic/anaconda3/envs/aiida/bin/mpirun -np 4 /home/tetsassic/anaconda3/envs/aiida/bin/lmp_mpi"
...
ase.visualize.plot.plot_atoms(
    structure, ax[1], radii=0.8, rotation=("0x, 45y, 45z")  # uncomment to visualize at different angles
)
ase.visualize.plot.plot_atoms(
    structure,
    ax[2],
...
lammps = LAMMPS(
    pair_style="meam", pair_coeff=["* * library.meam Ni  Ni.meam Ni"], files=files, keep_tmp_files=True, verbose=True
)
